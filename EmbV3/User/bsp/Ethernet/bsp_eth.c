...
extern __IO ETH_DMADESCTypeDef  *DMATxDescToSet;			//DMA发送描述符追踪指针
extern __IO ETH_DMADESCTypeDef  *DMARxDescToGet; 		//DMA接收描述符追踪指针
...
u8 BspEth_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_7;  //!< 配置PA1 PA2 PA7
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_4 | GPIO_Pin_5;//!< 配置PC1,PC4 and PC5
	GPIO_Init(GPIOC, &GPIO_InitStructure);
	GPIO_PinAFConfig(GPIOC, GPIO_PinSource1, GPIO_AF_ETH);             //!< 引脚复用到网络接口上
	GPIO_PinAFConfig(GPIOC, GPIO_PinSource4, GPIO_AF_ETH);
	GPIO_PinAFConfig(GPIOC, GPIO_PinSource5, GPIO_AF_ETH);                                
	 
	GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_11 | GPIO_Pin_13 | GPIO_Pin_14;//!< 配置PG11, PG14 and PG13
	GPIO_Init(GPIOG, &GPIO_InitStructure);
	GPIO_PinAFConfig(GPIOG, GPIO_PinSource11, GPIO_AF_ETH);
	GPIO_PinAFConfig(GPIOG, GPIO_PinSource13, GPIO_AF_ETH);
	GPIO_PinAFConfig(GPIOG, GPIO_PinSource14, GPIO_AF_ETH);	
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;                             //!< 配置PD3为推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
...
u8 ETH_MACDMA_Config(void)
{
	...
	ETH_SoftwareReset();  						//!< 软件重启网络ETH_SoftwareReset();
	...
	ETH_InitStructure.Sys_Clock_Freq=168;//系统时钟频率为192Mhz
